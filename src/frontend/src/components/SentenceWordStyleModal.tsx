...
interface SentenceWordStyleModalProps {
  open: boolean;
...
export function SentenceWordStyleModal({
  open,
  sentenceId,
  wordText,
  initialStyle,
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await onSave(sentenceId, wordText, style);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent
        data-ocid="sentence_word_style.dialog"
        className="max-w-lg"
      >
        <DialogHeader>
          <DialogTitle>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl border border-border bg-muted/40 p-4 flex items-center justify-center min-h-[72px]">
            <span style={previewCss}>{wordText}</span>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            >
              <SelectTrigger data-ocid="sentence_word_style.font.select">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              <Button
                data-ocid="sentence_word_style.upload_button"
                variant="outline"
                size="sm"
                className="gap-2"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2 items-center">
                <input
                  data-ocid="sentence_word_style.color.input"
                  type="color"
                  value={style.color}
                  onChange={(e) =>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                data-ocid="sentence_word_style.fontsize.input"
                type="number"
                min={12}
                max={72}
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              <Toggle
                data-ocid="sentence_word_style.bold.toggle"
                pressed={style.bold}
                onPressedChange={(v) =>
              ...
              <Toggle
                data-ocid="sentence_word_style.italic.toggle"
              ...
              <Toggle
                data-ocid="sentence_word_style.underline.toggle"
        ...
        <DialogFooter>
          <Button
            data-ocid="sentence_word_style.cancel_button"
            variant="outline"
            onClick={onClose}
          >
            Cancel
          ...
          <Button
            data-ocid="sentence_word_style.save_button"
            onClick={handleSave}
            disabled={saving}
          >
