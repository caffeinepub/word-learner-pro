...
interface WordCustomizationModalProps {
  word: Word | null;
  onClose: () => void;
  onSave: (text: string, style: WordStyle) => Promise<void>;
}

export function WordCustomizationModal({
  word,
  onClose,
  onSave,
}: WordCustomizationModalProps) {
  const [style, setStyle] = useState<WordStyle>(
    word?.style ?? {
      fontFamily: "Inter",
      color: "#1FA6A6",
      fontSize: 16n,
  ...
  return (
    <Dialog open={!!word} onOpenChange={(v) => !v && onClose()}>
      <DialogContent data-ocid="word_style.dialog" className="max-w-lg">
        ...
        {word && (
          <div className="space-y-5">
            ...
            <div className="rounded-xl border border-border bg-muted/40 p-4 flex items-center justify-center min-h-[72px]">
              <span style={previewStyle}>{word.text}</span>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              >
                <SelectTrigger data-ocid="word_style.font.select">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                <Button
                  data-ocid="word_style.upload_button"
                  variant="outline"
                  size="sm"
                  className="gap-2"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2 items-center">
                  <input
                    data-ocid="word_style.color.input"
                    type="color"
                    value={style.color}
                    onChange={(e) =>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  data-ocid="word_style.fontsize.input"
                  type="number"
                  min={12}
                  max={72}
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                <Toggle
                  data-ocid="word_style.bold.toggle"
                  pressed={style.bold}
                  onPressedChange={(v) =>
                ...
                <Toggle
                  data-ocid="word_style.italic.toggle"
                ...
                <Toggle
                  data-ocid="word_style.underline.toggle"
        ...
        <DialogFooter>
          <Button
            data-ocid="word_style.cancel_button"
            variant="outline"
            onClick={onClose}
          >
            Cancel
          ...
          <Button
            data-ocid="word_style.save_button"
            onClick={handleSave}
            disabled={saving}
          >
